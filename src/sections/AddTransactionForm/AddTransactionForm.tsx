    ...
    <BasicSection style={{ gridArea: 'B' }}>
      <Form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <FormLabel htmlFor='amount' offsetBottom>
            Amount *
          </FormLabel>
          ...
          <FormLabel htmlFor='account' offsetBottom>
            Account Number *
          </FormLabel>
          ...
          {/* address */}
          <FormLabel htmlFor='address' offsetBottom>
            Address
          </FormLabel>
          <Input id='address' name='address' offsetBottom fullWidth />

          {/* description */}
          <FormLabel htmlFor='description' offsetBottom>
            Description
          </FormLabel>
